...
var MultiMarkerComponent = /*#__PURE__*/ React.forwardRef(function(_ref, ref) {
  var id = _ref.id,
    styles = _ref.styles,
  ...
  useEffect(
    function() {
      ...
      markerRef === null || markerRef === void 0
        ...
        ? void 0
        : _markerRef$current7.setGeometries(builtGeometry$2(geometries || []));
    },
    [geometries],
  );
  useEffect(
...
var MarkerClusterComponent = function MarkerClusterComponent(props) {
  ...
  var _useState = useState(null),
    ...
    overlayIns = _useState2[0],
    setOverlayIns = _useState2[1];
  var markerClusterRef = useRef(null);
  useEffect(
    function() {
      if (map) {
  ...
  useEffect(
    function() {
      ...
      polygonRef === null || polygonRef === void 0
        ...
        ? void 0
        : _polygonRef$current2.setStyles(builtStyle$3(styles || {}));
    },
    [styles],
  );
  return null;
...
export {
  DomOverlayComponent as DomOverLay,
  InfoWindowComponent as InfoWindow,
  MapContext,
  MultiCircleComponent as MultiCircle,
  MarkerClusterComponent as MultiCluster,
  MultiLabelComponent as MultiLabel,
  MultiMarkerComponent as MultiMarker,
  MultiPolygonComponent as MultiPolygon,
  MultiPolylineComponent as MultiPolyline,
  TMapComponent as TMap,
};
